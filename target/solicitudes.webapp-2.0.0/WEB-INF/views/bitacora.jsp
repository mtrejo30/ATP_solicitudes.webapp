...
<spring:message var='title' code="Bitacora_Menu" />
...
function loaded()
{
	jQuery("#data_filter").autocomplete({
		source:"bitacora/activity-log-search-data.json", 
		minLength: 3});
	
	jQuery("#action_filter").autocomplete({
		source:"bitacora/activity-log-search-action.json", 
		minLength: 3});		
	...
	(
		{
			...
			url:'bitacora/activity-log-table-info.json',
			postData: 
			{
