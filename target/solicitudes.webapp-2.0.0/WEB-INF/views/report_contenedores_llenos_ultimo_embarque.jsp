...
<div id="leyenda" Style='width:600px;'>Te recordamos que toda la información aquí mostrada es de consulta, no es válida para reclamaciones de índole legal o comercial.</div>
	...
	<div id="cuadro" class="reportContainer wideFields" align=center>
		<form id="searchForm">
			...
			<!--  <a href="javascript:void(0);"  Style="background: none repeat scroll 0 0 #4CC8E4;color: #FFFFFF;font-size: 10px;padding: 5px 10px; cursor: pointer;text-decoration:none"  type="button" onclick="exportData('6','pdf','Consulta De Contenedores Llenos \u00DAltimo Embarque');">Guardar en PDF</a>-->
	...
	<form id="formstyle" action="GenerateGridPDFs" method="post" name="formstyle">
            ...
            <input type="hidden" name="fileName" id="fileName" value="Report_contenedores_llenos_ultimo_embarque" />
