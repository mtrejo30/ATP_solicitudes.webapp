...
<spring:message var='title' code="Report_contenedores_llenos_recepcion_puerta" />
...
<div id="leyenda" Style='width:600px;'>Te recordamos que toda la información aquí mostrada es de consulta, no es válida para reclamaciones de índole legal o comercial.</div>
	...
	<div id="cuadro" class="reportContainer wideFields" align=center>
		<form id="searchForm">
			...
			<!-- <a href="javascript:void(0);"  Style="background: none repeat scroll 0 0 #4CC8E4;color: #FFFFFF;font-size: 10px;padding: 5px 10px; cursor: pointer;text-decoration:none"  type="button" onclick="exportData('4','pdf','Consulta DE Contenedores Llenos Recepci\u00F3n por Puerta');">Guardar en PDF</a>-->
	...
	<br/>
		<form id="formstyle" action="GenerateGridPDFs" method="post" name="formstyle">
            ...
            <input type="hidden" name="fileName" id="fileName" value="Report_contenedores_llenos_recepcion_puerta" />
...
var baseUrl = "report_contenedores_llenos_recepcion_por_puerta";
...
{	
	...
	//currentMenu
	highlightNavigationBarReportsItem("contenedoresLlenos_RecepcionPorPuerta");
}
...
function buildTable()
{
	...
	(
	{
		...
		[
			...
			{name:'fechaDeIngreso', index:'fechaDeIngreso', sortable: false, width: 200, align: "left", label: "<spring:message code='Entry_date' />"},
