...
*/
    ...
    $.widget("ui.dropdownchecklist", {
        ...
        _appendControl: function() {
            ...
            wrapper.css( { display: "inline-block", cursor: "default" } );
            ...
            control.css( { display: "inline-block", 'white-space': 'nowrap'} );
...
****/
        ...
        _setSize: function(dropCalculatedSize) {
            ...
            dropWrapper.find(".ui-dropdownchecklist-dropcontainer").css({
                height: dropHeight + "px",
                //objectwave
                width: dropWidth + 6 + "px"  //added 6px margin + border (dropdownchecklist)
            });
        },
        ...
        refresh: function() {
            ...
            //ObjectWave
            var w = this.sourceSelect.css("width");
            // remove the px
            w = parseInt(w);
            self._setSize({width: w});
