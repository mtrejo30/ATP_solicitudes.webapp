...
<div class="solicitudHeaderContainer" align=center>
	...
	<tr>
		<td>
			...
			<input id="idagencia_" readonly type=text value="${agenciaAduanal.nombre}" />
		</td>
		<td>
			<label><spring:message code='Customer' />:</label>
			<input id="idcliente_" readonly type=text value="${cliente.nombre}" />
		</td>
...
<input type="hidden" id="folioSolicitud" value="${solicitud.user.empresa.codigo}" />
<input type="hidden" id="IdSolicitud" value="${solicitud.folio}" />