...
public interface SolicitudDao
{
	...
	List<Solicitud> getSolicitudByN4(String userN4,String idUser) throws Exception;
	List<Solicitud> getSolicitudByN4(String idUser) throws Exception;
	List<Solicitud> getSolicitudByIdUser(String idUser)throws Exception;
}
